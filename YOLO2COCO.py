...
parser.add_argument('--image_path', default='datasets/coco/images/val2017', type=str, help="path of images")
parser.add_argument('--label_path', default='datasets/coco/labels/val2017', type=str, help="path of labels .txt")
...
def yolo2coco(arg):
    ...
    with open('datasets/coco/classes.txt') as f:
