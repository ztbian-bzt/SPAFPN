...
class yolo_heatmap:
    ...
    def post_process(self, result):
        result = non_max_suppression(result, conf_thres=self.conf_threshold, iou_thres=0.65, softnms=False)[0]
        return result
...
def get_params():
    params = {
        'weight': 'weights/SPAFPNn-C2f.pt',  # 现在只需要指定权重即可,不需要指定cfg
        # 'weight': 'yolov8n.pt',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'datasets/Visualization', 'result')
